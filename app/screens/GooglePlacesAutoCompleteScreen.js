...
const GooglePlacesAutocompleteScreen = React.createClass({
  ...
  propTypes: {
    ...
    _isMounted: React.PropTypes.bool,
  },
  ...
  getDefaultProps() {
    return {
      ...
      query: {
        key: 'AIzaSyDQeAedSZv5gBmRv6ajtENr68PrFChuIEo',
        language: 'en',
        types: 'geocode',
      },
          ...
          if (typeof responseJSON.results !== 'undefined') {
            if (this._isMounted) {
              ...
              if (this.props.nearbyPlacesAPI === 'GoogleReverseGeocoding') {
                results = this._filterResultsByTypes(responseJSON,
...
module.exports = {
  GooglePlacesAutocompleteScreen,
};
